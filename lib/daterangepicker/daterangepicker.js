    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><span class="fa fa-chevron-left glyphicon glyphicon-chevron-left">&lt;</span></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><span class="fa fa-chevron-right glyphicon glyphicon-chevron-right">&gt;</span></th>';
            } else {
                html += '<th></th>';
            }
