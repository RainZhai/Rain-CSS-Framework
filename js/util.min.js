...
if(prop_name&&prop_name!==""){pubSub.publish(message,prop_name,target.value)}};if(document.addEventListener){document.addEventListener("keyup",changeHandler,false)}else{document.attachEvent("onkeyup",changeHandler)}pubSub.on(message,function(event,prop_name,new_val){var elements=document.querySelectorAll("["+data_attr+"="+prop_name+"]"),tag_name;for(var i=0,len=elements.length;i<len;i++){tag_name=elements[i].tagName.toLowerCase();if(tag_name==="input"||tag_name==="textarea"||tag_name==="select"){elements[i].value=new_val}else{elements[i].innerHTML=new_val}}});return pubSub};util.preview=function(file,callback){var reader=new FileReader();reader.onload=function(e){var $img=$("<img>").attr("src",e.target.result);if(typeof(callback)=="function"){callback($img)}};reader.readAsDataURL(file)};util.loading=util.tip=$.fn.loading=$.loading=function(obj){var opt=$.extend({icon:true,content:"",loadingStyle:{},loadingClass:"round-5",iconClass:"block center roundall o-5",iconStyle:{},iconSrc:"images/ajax-loader.gif",textStyle:{"font-size":"1.2em"},textClass:""},obj||{});var randomStr=Math.round(Math.random()*1000000+1)+"",_content=opt.content;var o={htmlobj:null,init:function(){o.initHtml();o.initUI()},initHtml:function(){if(!o.html){o.html=$('<div id="j_loader'+randomStr+'" class="j_loader'+randomStr+' ui-loader  posa fullh fullw hide"><div class="j_loadermain loadermain mlrauto"><img class="j_icon" /><div class="j_content tac"></div></div></div>')}if(_content){o.html.find(".j_content").html(_content)}return o.html},initUI:function(){o.html.find(".j_loadermain").addClass(opt.loadingClass);if(!opt.icon){o.html.find(".j_icon").hide()}o.html.find(".j_loadermain").css(opt.loadingStyle);o.html.find(".j_content").css(opt.textStyle);o.html.find(".j_content").addClass(opt.textClass);o.html.find(".j_icon").css(opt.iconStyle);o.html.find(".j_icon").addClass(opt.iconClass);o.html.find(".j_icon").attr("src",opt.iconSrc);$("body").append(o.html)},setContent:function(s){o.html.find(".j_content").html(s);return o},showIcon:function(v){if(!v){o.html.find(".j_loadermain").hide()}else{o.html.find(".j_loadermain").show()}return o},show:function(delay){o.html.show();if(delay>0){setTimeout(function(){o.html.hide()},delay)}return o},hide:function(){o.html.hide();return o},getHtml:function(){return o.html}};o.init();return o};util.listload=$.listload=function(obj,callback){var opt=$.extend({lastItemHandle:".list:last-child",loadurl:"",params:null,wrapHandle:"#listbox",loading:null,stop:false,scrollObj:window},obj||{});var win=$(opt.scrollObj);var wrapbox=$(opt.wrapHandle);var stop=opt.stop;var o={getDatabox:function(){return wrapbox},setParams:function(obj){opt.params=obj},getParams:function(){return opt.params},setData:function(d){o.data=d},getData:function(){return o.data},setStop:function(v){stop=v},init:function(){win.scroll(function(){log(stop);if(!stop&&$(opt.lastItemHandle).is(":visible")){if(win.scrollTop()+win.height()>=$(document).height()){o.setStop(true);if(opt.loadurl){var p=o.getParams();if(opt.loading){opt.loading.show()}$.getJSON(opt.loadurl,p,function(data){o.setData(data);if($.isFunction(callback)){callback()}})}}}});$(document).ready(function(){var a=$,b=document,c=a(".j_mainContent "),d=a(".j_sidebar");if(d.length>0){var e=d.offset().top,f=d.find(".anchor-btn"),g=function(){for(var b=[],c=0;c<f.length;c++){b.push(a(a(f[c]).attr("href")).offset().top)}return b},h=g(),i=function(b){for(var c,b=b+86,d=0;d<h.length;d++){if(b<h[d+1]){c=d;break}}void 0==c&&(c=d-1),f.parent("li").find("a").removeClass("on"),a(f[c]).parent("li").find("a").addClass("on")},j=function(a){a>e&&!d.hasClass("tab-fix-top")&&(d.addClass("tab-fix-top")),e>a&&d.hasClass("tab-fix-top")&&(d.removeClass("tab-fix-top"))};a(window).on("scroll",function(c){var d=a(b).scrollTop();j(d),i(d)}),a(window).on("resize",function(e){d.hasClass("tab-fix-top");var f=a(b).scrollTop();j(f),i(f)}),a(".anchor-btn").on("click",function(b){var c=a(this);setTimeout(function(){f.parent("li").find("a").removeClass("on"),c.parent("li").find("a").addClass("on")},50)});var k=a(b).scrollTop();j(k)}})}};o.init();return o}})(window,window.jQuery||window.Zepto);Array.prototype.indexOf=function(el){for(var i=0,n=this.length;i<n;i++){if(this[i]===el){return i}}return -1};Array.prototype.remove=function(val){var index=this.indexOf(val);if(index>-1){this.splice(index,1)}};