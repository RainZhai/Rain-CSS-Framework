...
define(['template'],function (t) {
	...
	'<div class="l fl wf-75 ggrey tac h-5 posr"><a class="ib fsm ts posa" style="top:10px; right:10px; " href="#/search"><svg class="h-2 w-2"><use xlink:href="#icon-search"></use></svg></a></div>'+
	'</div>'+
	'</div>';
