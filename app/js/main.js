require.config({
	...
	paths: {
		...
		commondata: ['app/js/app/data/common', 'http://rainzhai.github.io/raincss/app/js/app/data/common'],
		...
		catedata: ['app/js/app/data/category', 'http://rainzhai.github.io/raincss/app/js/app/data/category'],
