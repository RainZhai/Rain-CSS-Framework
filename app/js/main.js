require.config({
	...
	paths: {
		...
		html: ['http://rainzhai.github.io/raincss/app/js/lib/freehtml.min','lib/freehtml.min'],
		template:['http://cdn.staticfile.org/artTemplate.js/3.0/template', 'lib/template'],
		util:  ['http://rainzhai.github.io/raincss/app/js/lib/util.min','lib/util.min'],
		swipe: ['http://rainzhai.github.io/raincss/app/js/lib/swipe.min','lib/swipe.min'],
		slide: ['http://rainzhai.github.io/raincss/app/js/lib/slide.min','lib/slide.min'],
		headview: ['http://rainzhai.github.io/raincss/app/js/app/view/head','app/view/head'],
		footview: ['http://rainzhai.github.io/raincss/app/js/app/view/foot','app/view/foot'],
		navview: ['http://rainzhai.github.io/raincss/app/js/app/view/nav','app/view/nav'],
		commondata: ['http://rainzhai.github.io/raincss/app/js/app/data/common','http://wande.me/app/js/app/data/common'],
		//commondata: 'app/data/common',
		searchheadview: ['http://rainzhai.github.io/raincss/app/js/app/view/searchHead','app/view/searchHead'],
		searchmainview: ['http://rainzhai.github.io/raincss/app/js/app/view/searchMain','app/view/searchMain'],
		listview: ['http://rainzhai.github.io/raincss/app/js/app/view/list','app/view/list'],
		cateview: ['http://rainzhai.github.io/raincss/app/js/app/view/category','app/view/category'],
		catedata: ['http://rainzhai.github.io/raincss/app/js/app/data/category','http://wande.me/app/js/app/data/category'],
		//catedata: 'app/data/category',
		topicview: ['http://rainzhai.github.io/raincss/app/js/app/view/topic','app/view/topic'],
		topicdetailview: ['http://rainzhai.github.io/raincss/app/js/app/view/topicdetail','app/view/topicdetail'],
		gamepicview: ['http://rainzhai.github.io/raincss/app/js/app/view/gamepic','app/view/gamepic'],
		gamepicdetailview: ['http://rainzhai.github.io/raincss/app/js/app/view/gamepicdetail','app/view/gamepicdetail'],
		wplistview: ['http://rainzhai.github.io/raincss/app/js/app/view/wplist','app/view/wplist'],
		wpgamelistview: ['http://rainzhai.github.io/raincss/app/js/app/view/wpgamelist','app/view/wpgamelist'],
		wplistdetailview: ['http://rainzhai.github.io/raincss/app/js/app/view/wplistdetail','app/view/wplistdetail'],
		json: ['http://rainzhai.github.io/raincss/app/js/app/service/json','app/service/json']
	},
	shim: {
		'util': {
			deps: ['jquery'],
