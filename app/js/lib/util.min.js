...
if(opt.loading){opt.loading.show()}$.getJSON(opt.loadurl,p,function(data){o.setData(data);if($.isFunction(callback)){callback()}})}}}})}};o.init();return o}})(window,jQuery||Zepto);